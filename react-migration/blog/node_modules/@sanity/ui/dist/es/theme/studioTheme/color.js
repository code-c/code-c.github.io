...
export const color = createColorTheme({
    ...
    button: ({ base, mode, muted, solid }) => {
        if (mode === 'bleed') {
            return Object.assign(Object.assign({}, muted), { enabled: Object.assign(Object.assign({}, muted.enabled), { bg: base.bg, border: base.bg }), disabled: Object.assign(Object.assign({}, muted.disabled), { bg: base.bg, border: base.bg }) });
        }
        if (mode === 'ghost') {
            return Object.assign(Object.assign({}, solid), { enabled: Object.assign(Object.assign({}, muted.enabled), { bg: base.bg, border: base.border }), disabled: Object.assign(Object.assign({}, muted.disabled), { bg: base.bg }) });
        }
        return solid;
    },
    ...
    card: ({ base, dark, muted, name, state }) => {
        ...
        if (state === 'hovered') {
            ...
            return Object.assign(Object.assign({}, muted.hovered), { 
                // fg: base.fg,
