...
const InnerAutocomplete = forwardRef((props, ref) => {
    ...
    const openButtonNode = useMemo(() => openButton ? (React.createElement(Box, { padding: openButtonBoxPadding },
        React.createElement(Button, Object.assign({}, openButtonProps, { fontSize: fontSize, icon: ChevronDownIcon, mode: "bleed", onClick: handleOpenClick, padding: openButtonPadding })))) : undefined, [
        fontSize,
        handleOpenClick,
        openButton,
    ...
    return (React.createElement(Root, { "data-ui": "Autocomplete", onBlur: handleRootBlur, onKeyDown: handleRootKeyDown, ref: rootRef },
        React.createElement(TextInput, Object.assign({}, restProps, { "aria-activedescendant": activeItemId, "aria-autocomplete": "list", "aria-expanded": expanded, "aria-owns": listboxId, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", border: border, clearButton: clearButton, fontSize: fontSize, icon: icon, id: id, inputMode: "search", onChange: handleInputChange, onClear: handleClearButtonClick, onFocus: handleInputFocus, padding: padding, radius: radius, ref: setRef, role: "combobox", spellCheck: false, suffix: openButtonNode, value: query === null ? renderValue(value, currentOption) : query })),
