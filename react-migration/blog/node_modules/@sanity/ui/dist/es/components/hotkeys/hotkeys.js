...
export const Hotkeys = forwardRef((props, ref) => {
    ...
    return (React.createElement(Root, Object.assign({ "data-ui": "Hotkeys" }, restProps, { ref: ref }),
        React.createElement(Inline, { as: "span", space: space }, keys.map((key, i) => (React.createElement(Key, { fontSize: size, key: i, padding: padding, radius: radius }, key))))));
});
