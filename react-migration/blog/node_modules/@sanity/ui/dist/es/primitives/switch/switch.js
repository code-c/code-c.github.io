...
export const Switch = forwardRef((props, forwardedRef) => {
    const { checked, className, disabled, indeterminate, readOnly, style } = props, restProps = __rest(props, ["checked", "className", "disabled", "indeterminate", "readOnly", "style"]);
    ...
    return (React.createElement(Root, { className: className, "data-ui": "Switch", style: style },
        React.createElement(Input, Object.assign({ "data-read-only": !disabled && readOnly ? '' : undefined }, restProps, { checked: indeterminate !== true && checked, disabled: disabled || readOnly, type: "checkbox", ref: ref })),
