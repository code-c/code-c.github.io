...
export const Popover = forwardRef((props, ref) => {
    ...
    // @todo: memoize?
    const popoverStyle = Object.assign(Object.assign({}, style), styles.popper);
    const node = (React.createElement(Root, Object.assign({ "data-ui": "Popover" }, restProps, { "$preventOverflow": preventOverflow, ref: setRootRef, style: popoverStyle }, attributes.popper),
