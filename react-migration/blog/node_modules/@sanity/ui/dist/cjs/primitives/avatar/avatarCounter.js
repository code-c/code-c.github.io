...
function responsiveAvatarCounterSizeStyle(props) {
    ...
    return styles_1.responsive(media, props.$size, function (size) {
        ...
        if (!avatarSize)
            return constants_1.EMPTY_RECORD;
        return {
            borderRadius: styles_1.rem(avatarSize.size / 2),
            minWidth: styles_1.rem(avatarSize.size),
...
function avatarCounterBaseStyle(props) {
    var theme = props.theme;
    return styled_components_1.css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    align-items: center;\n    justify-content: center;\n    box-sizing: border-box;\n    user-select: none;\n    color: inherit;\n    color: var(--card-fg-color);\n    background: var(--card-bg-color);\n    box-shadow: 0 0 0 1px var(--card-bg-color), inset 0 0 0 1.5px var(--card-hairline-hard-color);\n    padding: 0 ", ";\n\n    &:not([hidden]) {\n      display: flex;\n    }\n  "], ["\n    align-items: center;\n    justify-content: center;\n    box-sizing: border-box;\n    user-select: none;\n    color: inherit;\n    color: var(--card-fg-color);\n    background: var(--card-bg-color);\n    box-shadow: 0 0 0 1px var(--card-bg-color), inset 0 0 0 1.5px var(--card-hairline-hard-color);\n    padding: 0 ", ";\n\n    &:not([hidden]) {\n      display: flex;\n    }\n  "])), styles_1.rem(theme.sanity.space[2]));
}
var Root = styled_components_1.default.div(responsiveAvatarCounterSizeStyle, avatarCounterBaseStyle);
function AvatarCounter(_a) {
    var count = _a.count, _b = _a.size, sizeProp = _b === void 0 ? 0 : _b, tone = _a.tone;
    var size = hooks_1.useResponsiveProp(sizeProp, [0]);
    return (react_1.default.createElement(Root, { "$size": size, "data-tone": tone },
