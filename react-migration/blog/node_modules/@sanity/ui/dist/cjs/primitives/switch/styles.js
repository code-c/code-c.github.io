...
function switchRepresentationStyles(props) {
    ...
    return styled_components_1.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    --switch-bg-color: ", ";\n    --switch-fg-color: ", ";\n\n    &:not([hidden]) {\n      display: block;\n    }\n    position: relative;\n    width: ", ";\n    height: ", ";\n    border-radius: ", ";\n\n    /* Make sure it\u2019s not possible to interact with the wrapper element */\n    pointer-events: none;\n\n    /* Focus styles */\n    input:focus + & {\n      box-shadow: ", ";\n    }\n\n    input:focus:not(:focus-visible) + & {\n      box-shadow: none;\n    }\n\n    input:checked + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n\n    @media (hover: hover) {\n      input:not(:disabled):hover + & {\n        --switch-bg-color: ", ";\n        --switch-fg-color: ", ";\n      }\n\n      input:not(:disabled):checked:hover + & {\n        --switch-bg-color: ", ";\n        --switch-fg-color: ", ";\n      }\n    }\n\n    input:not([data-read-only]):disabled + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n  "], ["\n    --switch-bg-color: ", ";\n    --switch-fg-color: ", ";\n\n    &:not([hidden]) {\n      display: block;\n    }\n    position: relative;\n    width: ", ";\n    height: ", ";\n    border-radius: ", ";\n\n    /* Make sure it\u2019s not possible to interact with the wrapper element */\n    pointer-events: none;\n\n    /* Focus styles */\n    input:focus + & {\n      box-shadow: ", ";\n    }\n\n    input:focus:not(:focus-visible) + & {\n      box-shadow: none;\n    }\n\n    input:checked + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n\n    @media (hover: hover) {\n      input:not(:disabled):hover + & {\n        --switch-bg-color: ", ";\n        --switch-fg-color: ", ";\n      }\n\n      input:not(:disabled):checked:hover + & {\n        --switch-bg-color: ", ";\n        --switch-fg-color: ", ";\n      }\n    }\n\n    input:not([data-read-only]):disabled + & {\n      --switch-bg-color: ", ";\n      --switch-fg-color: ", ";\n    }\n  "])), color.default.enabled.bg, color.default.enabled.fg, styles_1.rem(input.switch.width), styles_1.rem(input.switch.height), styles_1.rem(input.switch.height / 2), internal_1.focusRingStyle({ focusRing: focusRing }), color.positive.enabled.bg, color.positive.enabled.fg, color.default.hovered.bg, color.default.hovered.fg, color.positive.hovered.bg, color.positive.hovered.fg, color.default.disabled.bg, color.default.disabled.fg);
}
